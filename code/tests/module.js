...
try{
    ...
    //dojo.require("code.tests.this"); // Aborts all the remaining tests in Internet Explorer!
    ...
    //dojo.require("code.tests.patterns"); // Aborts all the remaining tests in Internet Explorer!
